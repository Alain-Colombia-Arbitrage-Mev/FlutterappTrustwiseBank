...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    trustwiseAuthUserSubject.add(
      TrustwiseAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TrustwiseAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TrustwiseAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TrustwiseAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    trustwiseAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
