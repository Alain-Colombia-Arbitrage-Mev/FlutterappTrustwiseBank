...
class AuthSignupWidget extends StatefulWidget {
  ...
  static String routeName = 'auth_signup';
...
class _AuthSignupWidgetState extends State<AuthSignupWidget> {
  ...
  void initState() {
    ...
    _model.fristnameTextController ??= TextEditingController();
    _model.fristnameFocusNode ??= FocusNode();
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 32.0, 0.0, 0.0),
                          child: wrapWithModel(
                            model: _model.loginwithsocialModel,
                            updateCallback: () => safeSetState(() {}),
                            child: LoginwithsocialWidget(),
                          ),
                        ),
                        Row(
                          mainAxisSize: MainAxisSize.max,
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.fristnameTextController,
                                      focusNode: _model.fristnameFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
                                      ...
                                      cursorColor: FlutterFlowTheme.of(context)
                                          .primaryText,
                                      validator: _model
                                          .fristnameTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
