...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AuthWelcomeScreen1Widget.routeName,
          path: AuthWelcomeScreen1Widget.routePath,
          builder: (context, params) => AuthWelcomeScreen1Widget(),
        ),
        FFRoute(
